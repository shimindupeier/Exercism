...
//    @Ignore
    ...
    fun `full time specified`() {
        val gigaSecond = Gigasecond(LocalDateTime.of(2015, Month.JANUARY, 24, 22, 0, 0), null)
...
//    @Ignore
    ...
    fun `full time with day roll-over`() {
        val gigaSecond = Gigasecond(LocalDateTime.of(2015, Month.JANUARY, 24, 23, 59, 59), null)
